...
use hash2curve::{ExpandMsgXof, hash_to_curve, hash_to_field, MapToCurve};
use rand_core::OsRng;
...
let [hashed_scalar] = hash_to_field::<1, EdwardsScalar, ExpandMsgXof<Shake256>, <EdwardsPoint as MapToCurve>::K>(&[b"test"], &[b"edwards448_XOF:SHAKE256_ELL2_RO_"]).unwrap();
...
let hashed_point = hash_to_curve::<EdwardsPoint, ExpandMsgXof<Shake256>>(&[b"test"], &[b"edwards448_XOF:SHAKE256_ELL2_RO_"]).unwrap();
